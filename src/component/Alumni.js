...
export default class Alumni extends Component {
      ...
      slideitems: [
        {
          ...
          description: 'Balendra, 32, popularly known as Balen Shah or simply Balen, is a Nepalese rapper, structural engineer and politician. He is currently serving as the 15th mayor of Kathmandu, the capital of Nepal. Shah has been a popular figure in Nepalese hip-hop since the early 2010s.'
        },
        {
          id: 101,
          img: Img2,
          ...
          description: 'Sunita Dangol is a Nepalese politician, Newa heritage conservationist, language activist, and media professional. She is currently serving as the deputy mayor of Kathmandu metropolitan city, the capital city of Nepal.'
        },
        {
          id: 103,
          img: Img3,
          ...
          description: 'City Police Superintendent Rajunath Pandey is the head of the Kathmandu Metropolitan City Police Force. Rajunath Pandey is known for his bold action.'
        },
        {
          id: 104,
          img: Img4,
          ...
          description: 'Dr. Karki is a general surgeon by education and practice. Alongside her medical profession, she has been actively vocal on the issues of health worker rights, physical attacks on medical professionals, and other pertinent malpractices in the Nepalese medical field.'
        },
      ],
    };
  }
  render() {
    ...
    const alumnilides = this.state.slideitems.map((slideitem, clientkey) => {
      return (
            ...
            <Row>
              <Col lg={12}>
                <div className="title-box text-center">
                  ...
                  <p className="text-muted f-17 mt-3">The college has constituted Alumni Association with a view to <br/>establish and strengthen close relation of its alumni with the college
                            </p>
            ...
            <Row>
              <Col lg={12}>
                <div className="title-box text-center">
                  ...
                  <p className="text-muted f-17 mt-3">We are providing work-integrated learning opportunities and getting students out into the real world.<br/>Our trusted companies will prepare students for success in their chosen field.</p>
                  <img src={HomeUrl} height="15" className="mt-3" alt="" />
                </div>
              </Col>
            </Row>
