                ...
                <Row className="align-items-center">
                  <Col lg={6}>
                    ...
                    <h5 className="text-muted mt-4">Profile Management</h5>
                      ...
                      <h1 className="home-title mt-4">Manage your Student<br /> Profile & Courses </h1>
                      <p className="text-muted mt-4 f-20">Nepalaya is created to help manage the student's profile management, starting from initial communication to course enrolment. </p>
